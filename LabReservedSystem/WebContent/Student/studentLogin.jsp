...
function loginSubmit(form1){
	if(form1.studentNumber.value==""){		//验证用户名是否为空
		alert("请输入学号！");form1.studentNumber.focus();return false;
	}
	if(form1.password.value==""){		//验证密码是否为空
		alert("请输入密码！");form1.passsword.focus();return false;
	}
	var param="studentNumber="+form1.studentNumber.value+"&password="+form1.password.value; 	//将登录信息连接成字符串，作为发送请求的参数

	var loader=new net.AjaxRequest("../StudentServlet?action=login&nocache="+new Date().getTime(),deal_login,onerror,"POST",encodeURI(param));
				...
				<div class="col-md-offset-3 col-md-6">
					<form class="form-horizontal" name="form1" method="post" action="">
						...
						<div class="form-group" >
							<input type="text" class="form-control" name="studentNumber" placeholder="学   号">
